...
{
    public class WardsAdministrationModel : PageModel
    {
        private readonly ILogger<IndexModel> _logger;
        ApplicationContext context;
        private readonly IConfiguration appConfig;
        public WardsAdministrationModel(ILogger<IndexModel> logger, ApplicationContext db, IConfiguration configuration)
        {
            _logger = logger;
            context = db;
